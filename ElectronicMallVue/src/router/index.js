...
const routes = [
    //前台
  {
    ...
    children: [
      ...
      {path: 'topview', name: 'topview', meta: {title:'在线商城'}, component: () => import('../views/front/TopView.vue'), requireAuth: true},
      {path: 'cart', name: 'cart', meta: {title:'我的购物车',requireLogin: true}, component: () => import('../views/front/good/Cart.vue'),},
      {path: 'goodList', name: 'goodList', meta: {title:'商品界面'}, component: () => import('../views/front/good/GoodList.vue'), requireAuth: true},
      {path: 'goodView/:goodId', name: 'goodview', meta: {title:'商品详情', requireLogin: true}, component: () => import('../views/front/good/GoodView.vue'), requireAuth: true},
      ...
      {path: 'collect', name: 'collect', meta: {title:'我的收藏',path: '商品/我的收藏',requireAuth: false}, component: () => import('../views/front/good/Collect.vue'),},
    ...
    //后台
  {
    ...
    children: [
      ...
      {path: 'marketingRank', name: 'marketingRank', meta: {title:'营销排行',path: '营收/营销排行',requireAuth: true}, component: () => import('../views/manage/income/MarketingRank.vue'),},
