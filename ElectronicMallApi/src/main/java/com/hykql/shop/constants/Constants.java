...
public class Constants {
    ...
    public static final String fileFolderPath = System.getProperty("user.dir") + File.separator + "file" + File.separator;
    public static final String avatarFolderPath = System.getProperty("user.dir") + File.separator + "avatar" + File.separator;
}